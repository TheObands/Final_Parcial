...
<html>
    ...
    <body>
        ...
        <div id="show-homepage" class="content scaffold-show" role="main">
            ...
            <f:display bean="homepage" />
            <g:form resource="${this.homepage}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.homepage}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
